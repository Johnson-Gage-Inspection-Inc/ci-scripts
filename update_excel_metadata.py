...
def _infuseMetadata(commit_hash: str = None, release_tag: str = None):
    ...
    if version_elem is None:
        version_elem = ET.Element('{http://schemas.openxmlformats.org/package/2006/metadata/core-properties}version')
    ...
    if keywords_elem is not None:
        ...
        keywords_elem = ET.Element('{http://schemas.openxmlformats.org/package/2006/metadata/core-properties}keywords')
